  ...
  data: [
    {
      ...
      skills: [
        ...
        "⚡ Developing AI tools for applications in lightweight design and healthcare industry",
        "⚡ Experienced in applying machine learning and deep learning techniques",
        "⚡ Proficient in data generation, augmentation, mining, and visualization",
      ],
      softwareSkills: [
        // {
        //   skillName: "PyTorch",
    ...
    },
    {
      ...
      skills: [
        "⚡ Developing algorithms to make efficient systems for industry.. to be edited",
        "⚡ Experienced in numerical simulations and optimization techniques.",
        "⚡ Proficient in mathematical modeling, scientific programming, and data analysis.",
      ],
      softwareSkills: [
        // {
        //   skillName: "Tensorflow",
    ...
    },
    {
      ...
      softwareSkills: [
        ...
        {
          skillName: ".NET",
          imageSrc: "dot_net_logo.png",
        },
        {
          skillName: "Blazor",
          imageSrc: "blazor_logo.png",
        },
        // {
        //   skillName: "Sass",
